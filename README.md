...
#### Configure Scripts
If you want to generate `mdGeoJavaWrapper.dll`, you will execute the `BuildGeoJavaWrapper.ps1` script. This may require you to configure some path variables in `BuildWrapper.ps1` and `BuildGeoJavaWrapper.ps1`.
